      ...
      <div className="mx-6 py-10 text-center md:text-left">
        <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          <div className="">
            ...
            <p>
            Discover luxury and practicality with our smart automated blinds from MagicBlinds.
            Designed to give you total control and convenience, 
            our curtains are the perfect fusion of advanced technology and contemporary elegance.
            </p>
          </div>
          <div className="">
            <h6
